    ...
    <section>
        ...
        <el-col :span="24" class="toolbar">
            <el-form :inline="true">
                ...
                <el-form-item>
                    <el-select v-model="queryModel.endpointName" filterable allow-create placeholder="接口名称">
                        <el-option label="请选择" value=""></el-option>
        ...
        <el-table :data="segmentList" stripe border style="width: 100%">
            ...
            <el-table-column prop="service_name" label="应用名称" width="150"></el-table-column>
            ...
            <el-table-column prop="errorMsg" label="异常信息" width="200"></el-table-column>
